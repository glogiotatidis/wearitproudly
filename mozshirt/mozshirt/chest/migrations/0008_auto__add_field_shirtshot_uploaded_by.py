...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShirtShot.uploaded_by'
        db.add_column('chest_shirtshot', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='shots', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShirtShot.uploaded_by'
        db.delete_column('chest_shirtshot', 'uploaded_by_id')
    ...
    models = {
        ...
        'chest.shirtshot': {
            ...
            'shirt': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shots'", 'to': "orm['chest.Shirt']"}),
            'uploaded_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shots'", 'to': "orm['auth.User']"})
        },
