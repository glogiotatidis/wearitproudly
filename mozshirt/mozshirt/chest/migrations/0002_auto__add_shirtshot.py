...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShirtShot'
        db.create_table('chest_shirtshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shirt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chest.Shirt'])),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('chest', ['ShirtShot'])


    def backwards(self, orm):
        # Deleting model 'ShirtShot'
        db.delete_table('chest_shirtshot')
